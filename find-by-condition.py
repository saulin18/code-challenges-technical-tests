#d within array
#742484% of 5541,154 of 3,901kylehill
#Python
...
def find_in_array(seq: List[int], predicate): 
    return next((index for index, value in enumerate(seq) if predicate(value, index)), -1)