...
# headA and headB to your program. If you correctly return the intersected node, then
...
# to two different locations in memory, while the nodes with value 8 in A and B (3rd node in 
