...
def romanToInt(self, s):
        ...
        # We are going to use a iterate backwars approach and decide whether to add or subtract
        ...
        for i in range(len(s) - 1, -1, -1):
            ...
            if i < len(s) - 1 and map_of_roman_numerals[s[i]] < map_of_roman_numerals[s[i + 1]]:
                total -= map_of_roman_numerals[s[i]]
            else:
                total += map_of_roman_numerals[s[i]]