...
# consists of choosing k adjacent and equal letters from s and removing them, causing the
        ...
        for char in s:
            if stack and stack[-1][0] == char:
                ...
                if frequency + 1 == k:
                    stack.pop()
                    continue
                stack[-1] = char, frequency + 1
                continue
            stack.append((char, 1))

        return "".join(char * frequency for char, frequency in stack)


s = "pbbcggttciiippooaais"
k = 2
print(Solution.removeDuplicates(Solution, s, k))
