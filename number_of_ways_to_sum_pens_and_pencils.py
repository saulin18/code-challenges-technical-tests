...
# You are also given two integers cost1 and cost2 indicating the price
# of a pen and pencil respectively. You can spend part or all of your
# money to buy multiple quantities (or none) of each kind of writing utensil.
# Return the number of distinct ways you can buy some number of pens
# and pencils.
# Example 1:
...
# so you cannot buy any writing utensils.
