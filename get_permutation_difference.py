...
#     The absolute difference between the index of the occurrence of "a" in s and the index of t
# he occurrence of "a" in t.
#     The absolute difference between the index of the occurrence of "b" in s and the index 
# of the occurrence of "b" in t.
#     The absolute difference between the index of the occurrence of "c" in s and the index of
# the occurrence of "c" in t.
...
class Solution:
    def findPermutationDifference(self, s: str, t: str) -> int:
        char_to_index_of_s = {char: i for i, char in enumerate(s)}
        char_to_index_of_t = {char: i for i, char in enumerate(t)}
        return sum(abs(char_to_index_of_s[char] - char_to_index_of_t[char]) for char in s)
