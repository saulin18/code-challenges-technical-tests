...
# from the cell that you picked in the previous row. F
# or every two adjacent rows r and r + 1 (where 0 <= r < m - 1),
# picking cells at coordinates (r, c1) and (r + 1, c2) will subtract abs(c1 - c2)
# from your score.
