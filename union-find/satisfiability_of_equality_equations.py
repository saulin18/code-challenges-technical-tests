...
# each string equations[i] is of length 4 and takes one of two different forms: "xi==yi" or "xi!=yi".Here, xi and yi
    ...
    def equationsPossible(self, equations: List[str]) -> bool:
        ...
        for equation in equations:
            if equation[1] == '=':
                ...
                pendings.append((first, second))
        
        for first, second in pendings:
