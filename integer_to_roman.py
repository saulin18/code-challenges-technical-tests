...
# of the maximal value that can be subtracted from the input, append that symbol 
# to the result, subtract its value, and convert the remainder to a Roman numeral.
...
# IV and 9 is 1 (I) less than 10 (X): IX. Only the following subtractive 
